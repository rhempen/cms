...
//  plugins : "autosave,contextmenu,emotions,save,searchreplace,visualchars,advimage,fullscreen,table",
    plugins: "contextmenu,fullscreen,searchreplace,table,advimage,paste,preview,media",
    ...
    theme_advanced_buttons2: "anchor,separator,link,unlink,separator,charmap,separator,undo,redo,separator,search,replace,separator,tablecontrols,separator,image,media",
