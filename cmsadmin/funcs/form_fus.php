...
function convert_umlaute2($text) {
    ...
    $ersetzung[14] = 'c';
    $suchmuster[15] = '/\s/';
    $ersetzung[15] = '_'; // Leerschlag durch _ ersetzen	
    $suchmuster[16] = '/[^a-zA-Z0-9]*\./';
    $ersetzung[16] = ''; // Alle Sonderzeichen durch space ersetzen
    $suchmuster[17] = '/-{1,}/';
    $ersetzung[17] = '_'; // doppelte oder mehr Bindestriche durch einen ersetzen
    $suchmuster[18] = '/_{2,}/';
    $ersetzung[18] = '_'; // doppelte oder mehr Unterstriche durch einen ersetzen
