...
function check_form() {
  ...
  var fehler="", fehler_code="", fehler_email="";
  $("kontaktcode").setStyle({ display:'none' });
  ...
  if (fehler != ""){
    var fehlertext = markedfields || "Bitte f&uuml;llen Sie die markierten Felder aus ";
    if (fehler_email != '') { $("kontaktemail").innerHTML = wrongemail || fehler_email; }
