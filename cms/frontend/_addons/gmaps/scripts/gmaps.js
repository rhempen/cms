...
//        createMap();
      ...
      $('#resulttable').dataTable().makeEditable( {
          ...
          "aoColumns": [
                          ...
                          },
                          {
                              type: 'select',
                              onblur: 'submit',
                              data: "{'vollsortiment':'vollsortiment','teilsortiment':'teilsortiment'}"
                          },
                          {
                              type: 'select',
                              onblur: 'submit',
  ...
  function createMarkers(markers) 
  {
    ...
    for (i = 0; i < markers.length; i++) {
      ...
      var lQuery = mid != '' ? nam+","+adr+","+ort : gQuery;
      var hlnk = "<a target='exakt' href='http://maps.google.ch?f=q&q="+lQuery+"'>"+adr+"<br>"+ort+"</a>"; 
      var html = "<h3>" + nam + "</h3>" + hlnk; 
//        var html = "<h3>" + nam + "</h3>" + adr + "<br />" + ort; 
...
//      setZentrum( gLatZentrum, gLngZentrum );
  ...
  function createTable(markers,ui) 
  {
    ...
    var lRow = new Array(), lCells = new Array();
    var lFields, lLst;
    if (ui == 'front') {
      lFields = new Array("nam","adr","ort");      
