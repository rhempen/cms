<?php
	...
	// File: config.inc.php
	// ================================================
	// Revision: 1.2.8                 Date: 02/01/2008
	// ================================================
...
//		),	
	...
	$cfg['ilibs_dir'] 	   = array('/cms/media/');						   	// image library path with slashes; absolute from root directory  e.g. '/pictures/' - please make sure that the directories have write permissions
