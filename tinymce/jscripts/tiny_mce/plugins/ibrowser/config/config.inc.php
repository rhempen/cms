...
/*		array (
	...
	$cfg['ilibs'] = array (																// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions	
		array (																		
			'value'   	=> '/cms/media/'.$GLOBALS['site_media'].'/',												
			'text'    	=> 'Site Pictures',
		),
//		array (
//			'value'   	=> '/ibrowser/pictures/', 				
//			'text'    	=> 'Gallery',
//		),	
	);
	//-------------------------------------------------------------------------
	...
	$cfg['ilibs_dir'] 	   = array('/cms/media/'.$GLOBALS['site_media'].'/');						// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions
