/**
 * $Id: mcimagemanager.js 659 2009-02-06 15:06:55Z spocke $
 *
 * @author Moxiecode
...
(function() {
	window.mcImageManager = {
		...
		moozAdd : function() {
			...
			if (window.moozcms) {
				t.baseURL = moozcms.baseURL + '/plugins/imagemanager/js';

				jQuery().bind('filePicker:browse', function(e, o) {
					if (o.type == 'media' || o.type == 'image')
						t.browse(o);
				});
			}
		}
