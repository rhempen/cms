<?php
	...
	$website =  '../../../../../includes/website.php';
	if (is_file($website)) { require_once($website); } 
	$website =  '../../../../../../includes/website.php';
	if (is_file($website)) { require_once($website); } 
	if (!defined('WEBSITE')) {
		$_SESSION['site_media'] = '';		
		...
		$_SESSION['site_media'] = 'media_'.$website;				
	}
...
//	$mcImageManagerConfig['filesystem.rootpath'] = '../../../../../media/'.$_SESSION['site_media']; // absolute or relative from this script path, required.
	$mcImageManagerConfig['filesystem.rootpath'] = '../../../../../'.$_SESSION['site_media']; // absolute or relative from this script path, required.
