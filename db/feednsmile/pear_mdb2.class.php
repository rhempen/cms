...
if (preg_match('/^hero/', $_SERVER['HTTP_HOST']) || $_SERVER['HTTP_HOST'] == 'localhost') {
    ini_set('include_path', ini_get('include_path') . ';c:\xampp711\php\PEAR;c:\xampp711\htdocs\\' . ROOTDIR);
...
elseif ($_SERVER['HTTP_HOST'] == 'www.feednsmile.ch' || $_SERVER['HTTP_HOST'] == 'feednsmile.ch') {
    ini_set('include_path', ini_get('include_path'));
    $login_file = '/home/httpd/vhosts/feednsmile.ch/httpdocs/db/feednsmile/db_login_pear.php';
}
